...
/**
 * Servlet implementation class CountCheckStudent_Good
 */
@WebServlet("/CountCheckStudent_Good")
public class CountCheckStudent_Good extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public CountCheckStudent_Good() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String count_sql = "select count(student_id) as present_num from all_check_info where subject_id= '"
				...
				+ " and ischeck <> 0 and ischeck <> 2 and ischeck <> 3 and ischeck <> 4 and ischeck <> -1";
		try {
			// 连接数据库
			...
			// 输出结果
			System.out.println("Good Check Student num:	" + present_student_num);
