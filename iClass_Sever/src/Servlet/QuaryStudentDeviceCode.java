...
/**
 * Servlet implementation class QuaryDeviceCode
 */
@WebServlet("/QuaryStudentDeviceCode")
public class QuaryStudentDeviceCode extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public QuaryStudentDeviceCode() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String quary_sql = "select device_code from student where student_id='" + student_id + "'";
		try {
			// 连接数据库
